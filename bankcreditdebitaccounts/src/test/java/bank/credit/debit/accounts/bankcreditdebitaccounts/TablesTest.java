package bank.credit.debit.accounts.bankcreditdebitaccounts;
...
public class TablesTest {
    ...
    public void testColumnNamesOfCreditCardTable() throws SQLException {
        ...
        assertTrue(columnsAreValid, "The table CREDIT_CARD does not contain all exp" +
                "ected columns like CREDIT_ACCOUNT_ID, ID");
    }
